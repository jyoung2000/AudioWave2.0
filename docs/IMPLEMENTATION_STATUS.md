...
|                                                                                                      | Status   | Notes                                                                                                            |
| ---------------------------------------------------------------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------- |
| `contracts` — one canonical Zod schema per concept                                                   | **Done** | 70 schemas, 119 routes; JSON Schema and OpenAPI generated from it, and CI fails if the generated files are stale |
...
| All 119 API routes                                                                                            | **Done**      | A contract test asserts every declared route has a handler                                                   |
