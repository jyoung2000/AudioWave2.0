...
const PATHS = {
  ...
  // Discover: a burst, because what it does is find something you did not ask for.
  discover: 'M10 5.4l1.7 5.4 5.4 1.7-5.4 1.7L10 19.6l-1.7-5.4L2.9 12.5l5.4-1.7zM18.4 2.6l.8 2.6 2.6.8-2.6.8-.8 2.6-.8-2.6-2.6-.8 2.6-.8z',
